      ...
      <AnimatePresence>
        {lightboxIndex !== null && (
          <motion.div
            ...
            aria-modal="true"
          >
            {/* Top Bar: Close Button & Meta info */}
            <div className="flex items-center justify-between z-20">
              <div className="text-left space-y-1">
                <span className="text-[9px] font-sans tracking-[0.3em] text-primary uppercase block">
              ...
              <button
                ...
                className="group flex items-center justify-center p-3 text-white/70 hover:text-white border border-white/10 hover:border-white/30 rounded-full transition-all duration-300 focus:outline-none"
            ...
            {/* Middle Container: Image & Navigation */}
            <div className="relative flex-1 flex items-center justify-center py-6">
              {/* Prev Button */}
              <button
                onClick={handlePrevLightbox}
                className="absolute left-0 md:left-4 z-20 group p-4 border border-white/5 hover:border-white/20 hover:bg-white/5 text-white/50 hover:text-white rounded-full transition-all duration-300 focus:outline-none"
              ...
              {/* Main Image with motion details */}
              <div className="relative max-w-5xl w-full h-full max-h-[70vh] flex items-center justify-center">
              ...
              <button
                ...
                className="absolute right-0 md:right-4 z-20 group p-4 border border-white/5 hover:border-white/20 hover:bg-white/5 text-white/50 hover:text-white rounded-full transition-all duration-300 focus:outline-none"
